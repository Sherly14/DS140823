...
# night = True # True - 1 , False - 0
# print("bool to int:",night," ",type(night), " ",int(night), " " ,type(int(night)))
# print("bool to float:",night," ",type(night), " ",float(night), " " ,type(float(night)))
# print("bool to str:",night," ",type(night), " ",str(night), " " ,type(str(night)))
# print("bool to bool:",night," ",type(night), " ",bool(night), " " ,type(bool(night)))
